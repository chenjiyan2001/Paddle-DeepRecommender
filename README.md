...
| :------| :------ | :------ | :------| :------ | -------|
| DeepRecommender | 0.9103 | [n(17768), 512, 512, 1024] | 128        | 45        | 约55秒 |

在其他数据下模型的指标如下：
| 数据集 | rmse   | layer_sizes               | batch_size | epoch_num | Time of each epoch |
| :----- | :----- | :------------------------ | :--------- | :-------- | ------------------ |
| N3M    | 0.9487 | [n(17736), 128, 256, 256] | 128        | 60        | 约25秒             |
| N6M    | 0.9206 | [n(17757), 256, 256, 512] | 128        | 60        | 约35秒             |
| N1Y    | 0.9220 | [n(16907), 256, 256, 512] | 128        | 42        | 约35秒             |
